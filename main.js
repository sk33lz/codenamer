...
(function() {
  var $alliterate, DEBUG, PARTS, TWITTER, bind, cats, final_name, name_parts, optionsFor, parts_, selects, sourceInfo, tweetButton, _i, _ref, _results;
  ...
  jQuery(function($) {
    ...
    return $('#share').append(" ").append(tweetButton(final_name));
  });
